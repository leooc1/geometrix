...
export default function Cadastro(){
    ...
    return(
        <main className="flex flex-col w-full h-screen justify-center items-center sm:flex-row sm:justify-evenly "
             style={{
            ...
            <section className='scale-100 sm:scale-110'>
                <form className="flex flex-col items-center gap-2">
                    ...
                    <label className="relative">
                        <input  className="bg-DarkerColor w-80 my-1 p-2 pl-9 rounded-xl text-white" type="email" name="email" id="email" placeholder="nome@email.com" required />
                    ...
                    <label className="relative">
                        <input  className="bg-DarkerColor w-80 my-1 p-2 pl-9 rounded-xl text-white" type="password" name="password" id="password" placeholder="Senha" required />
                    ...
                    <label className="relative">
                        <input  className="bg-DarkerColor w-80 my-1 p-2 pl-9 rounded-xl text-white" type="text" name="name" id="name" placeholder='Nome' required />
                    ...
                    <Link to='/'><button className="bg-DarkerColor w-48 my-1 mt-4 p-2 rounded-xl text-white">CADASTRAR</button></Link>
                </form>
            </section>
            <section className='scale-100 sm:scale-110'>
