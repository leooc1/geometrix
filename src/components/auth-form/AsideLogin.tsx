  ...
  return (
    <section className='w-80 bg-primary p-5 relative hidden md:flex'>
                ...
                <div className={`w-full h-full absolute top-0 left-0 ${mostrarSenha ? '':'overflow-hidden' }`}>
                    <Image className={`w-full h-full animation absolute top-0 ${mostrarSenha ? 'view-active': 'left-[-220px]'}`} src={'/auth/view-pw.svg'} alt='mostrar senha ' width={100} height={100} />
                </div>
            </section>
  )
}
